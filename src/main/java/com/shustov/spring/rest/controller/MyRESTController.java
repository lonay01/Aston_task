...
public class MyRESTController {
    ...
    @PostMapping("/add_momey")
    public String addMoney(@RequestParam int id, @RequestParam int money) {
    ...
    @PostMapping("/delete")
    public String delete(@RequestParam int  id1, @RequestParam int pin, @RequestParam int howMuch) throws Exception {
    ...
    public String transfer(@RequestParam int  id1, @RequestParam int id2, @RequestParam int pin, @RequestParam int howMuch) throws Exception {
